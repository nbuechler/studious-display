    ...
    return (
      <div style={{paddingBottom: '100px'}}>
        ...
        <Picker value={selectedExperienceDataset}
                ...
                options={['0', '1', '2', '3']}
                apiOptions={['experiencesOverview', 'experiencesStatistics', 'experienceHasWord', 'experienceContainsLog']}
                displayOptions={['View all experiences', 'Experiences Statistics', 'Experience Clusters (Words)', 'Experience Clusters (Logs)']}
